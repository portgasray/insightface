...
def load_image_from_bin(bin_path, save_dir):
    ...
    file = open(os.path.join(save_dir, 'pair.txt'), 'w')
...
if __name__ == '__main__':
    ...
    bin_path = '/home/rd-lzhang/workspace/repo/face-reg/insightface/images/lfw.bin'
    save_dir = '/home/rd-lzhang/workspace/repo/face-reg/insightface/images/lfw/'
